class Storage {
  ...
  static deleteFilmFromStorage(filmAdi) {
    let films = this.getStorage();
    ...
    films.forEach(function (film, index) {
      ...
      if (film === filmAdi) {
        //!!if bloğuna girmiyor-> çözüm trim özelliği çalıştırılmalı                                        //!!!  silme işleminden sonra bir önceki elemanı da siliyor -> çözüm hepsini büyük harfe çevir ve trim kullan
